...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_content">
                <table width="100%">
                    ...
                    <td width="50%" style="text-align: right;">
                        <a href="<?php echo base_url();?>file/template_XIII.xlsx">
        ...
        <div class="x_panel">
            ...
            <div id="parent_tabel_upload_atasxiii"></div>
        </div>
    </div>
</div>
...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header" style="background-color: powderblue;">
            ...
            <h4 class="modal-title" id="myModalLabel" style="color: navy;">Upload</h4>
        </div>

            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <button type='button' class='btn btn-primary' onclick="button_filter_periode_gaji_atas13()"><i class="fa fa-search"></i></button>&emsp;
                        </div>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="jml_potongan" id="jml_potongan" required>
            ...
            <input type="hidden" name="tf_cimb_niaga" id="tf_cimb_niaga" required>
            <input type="hidden" name="tf_bca" id="tf_bca" required>

            <input type="hidden" name="nik" id="nik" required>
            <input type="hidden" name="thr" id="thr" required>
